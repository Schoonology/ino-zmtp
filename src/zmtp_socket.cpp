...
zmtp_socket_state_t parse_greeting(zmtp_socket_state_t old_state,
...
ZMTPSocket::~ZMTPSocket() { delete this->identity; }
...
bool ZMTPSocket::ready() { return this->state == READY; }
